...
<body class="simple-page">
	...
	<div class="simple-page-wrap">
		<div class="simple-page-logo animated swing">
				...
				<span style="color: white " class="title">DHCS</span>
			
		</div><!-- logo -->
		<div class="simple-page-form animated flipInY" id="login-form">
	<h4 class="form-title m-b-xl text-center title">Sign Up With Your DHCS Account</h4>
	<form action="" method="post">
		<div class="form-group">
			<input id="fname" type="text" class="form-control" placeholder="Full Name" name="fname" required="true">
		</div>

		<div class="d-flex-inline flex__box">
		<div class="form-group">
		...
		<div class="form-group">
			<input id="certificate" type="text" placeholder="Doctor ID" class="form-control" name="certificate" required="true">
		</div>
