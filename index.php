...
<html lang="en">
    <head>
        <title> Digital Healthcare Booking System </title>
                            ...
                            <div id="myCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="images/slider/young-asian-female-dentist-white-coat-posing-clinic-equipment.jpg" class="img-fluid"  width="5000"height="2000" alt="" width="5000"height="2000">
                                    </div>

                                    <div class="carousel-item">
                                        <img src="images/img 2.avif" class="img-fluid" alt="" width="5000"height="2000">
                                    </div>
                                    ...
                                    <div class="carousel-item">
                                        <img src="images/slider/doctor-s-hand-holding-stethoscope-closeup.jpg" class="img-fluid" alt=""  width="5000"height="2000" >
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            ...
                            if ($query->rowCount() > 0) {
                                foreach ($results as $row) {
                                    ?>
                            <h2 class="mb-lg-3 mb-3 about__font"><?php echo htmlentities($row->PageTitle); ?></h2>

                            <p class="about__description" ><?php echo ($row->PageDescription); ?>.</p>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-6 ps-0">
                            <img src="images/female-doctor-with-presenting-hand-gesture.jpg" width="700" height="150" class="img-fluid galleryImage" alt="get a vaccine" title="get a vaccine for yourself">
                        </div>

                        <div class="col-lg-6 col-6 pe-0">
                            <img src="images/General-surgery-min.png " width="700" height="530" class="img-fluid galleryImage" alt="wear a mask" title="wear a mask to protect yourself">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 mx-auto">
                            <div class="booking-form">
                                ...
                                <h2 class="text-center mb-lg-3 mb-2 booking__title">Book an Appointment</h2>
